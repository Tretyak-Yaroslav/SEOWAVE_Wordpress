...
class Profilegrid_Woocommerce {
	...
	private function define_public_hooks() {
            ...
            $this->loader->add_action('profile_magic_profile_tab',$plugin_public, 'pg_purchases_tab',10,2);
            $this->loader->add_action('profile_magic_profile_tab_content',$plugin_public, 'pg_show_purchases_tab_content',10,2);
            $this->loader->add_action('profile_magic_profile_tab',$plugin_public, 'pg_product_review_tab',10,2);
            $this->loader->add_action('profile_magic_profile_tab_content',$plugin_public, 'pg_show_product_review_tab_content',10,2);
