...
class Profilegrid_Groups_Menu extends WP_Widget {
    ...
    public function __construct() {
        $widget_options = array(
          ...
          'description' => __('List ProfileGrid Groups','profilegrid-user-profiles-groups-and-communities'),
        );
        parent::__construct( 'pg_groups_menu', __('ProfileGrid Groups Menu','profilegrid-user-profiles-groups-and-communities'), $widget_options );
    }
    ...
    public function form($instance)
    {
        ...
        <p>
            <label><?php _e('Display Group Icon/Badge:','profilegrid-user-profiles-groups-and-communities');?></label>
        ...
        ?>
            <li>
                <div class="pm-slab"><?php _e("You haven't created any Profile Groups yet.",'profilegrid-user-profiles-groups-and-communities'); ?></div>
            </li>
        <?php
        endif;
        ?>
