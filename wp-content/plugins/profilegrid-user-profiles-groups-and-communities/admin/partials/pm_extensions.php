        ...
        <div class="pg-ext-list" id="the-list">
            ...
            <div class="plugin-card pg-ext-card">
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("A brand new ProfileGrid extension that adds social activity to your User Groups. Now users can create new posts, comment on other users' posts and browse Group timeline. Group wall is accessible from Group page as a new tab.","profilegrid-user-profiles-groups-and-communities");?></p>
             ...
             <div class="plugin-card pg-ext-card">
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e('Start accepting credit cards on your site for Group memberships and registrations by integrating popular Stripe payment gateway.','profilegrid-user-profiles-groups-and-communities');?></p>
                        <p class="authors"> <cite><?php _e('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="http://profilegrid.co"><?php _e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                    </div>
                </div>
                ...
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("Now take complete control of your users' display names. Mix and match patterns and add predefined suffixes and prefixes. There's a both global and per group option allowing display names in different groups stand out!","profilegrid-user-profiles-groups-and-communities");?></p>
                        <p class="authors"> <cite><?php _e('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="http://profilegrid.co"><?php _e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                    </div>
                </div>
                ...
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("Allow your users to create and share Photo Albums within their Groups. There's also an option for public photos. Users can enlarge and comment on different photos. ","profilegrid-user-profiles-groups-and-communities");?></p>
            ...
            <div class="plugin-card pg-ext-card">
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("Define how your user profile URL's will appear to site visitors and search engines. Take control of your user profile permalinks and add dynamic slugs.","profilegrid-user-profiles-groups-and-communities");?></p>
                        <p class="authors"> <cite><?php _e('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="http://profilegrid.co"><?php _e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                    </div>
                </div>
            ...
            <div class="plugin-card pg-ext-card">
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("Create and add custom fields to groups too! Now your user groups can have more detailed information and personality just like your user profile pages.","profilegrid-user-profiles-groups-and-communities");?></p>
                        <p class="authors"> <cite><?php _e('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="http://profilegrid.co"><?php _e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                    </div>
                </div>
                ...
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("Generate maps showing locations of all users or specific groups using simple shortcodes. Get location data from registration form.","profilegrid-user-profiles-groups-and-communities");?></p>
                        <p class="authors"> <cite><?php _e('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="http://profilegrid.co"><?php _e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                    </div>
                </div>
                ...
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("Allow registered users to create new Groups on front end. These Groups behave and work just like regular ProfileGrid groups.","profilegrid-user-profiles-groups-and-communities");?></p>
                        <p class="authors"> <cite><?php _e('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="http://profilegrid.co"><?php _e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                    </div>
                </div>
                ...
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("Integrate ProfileGrid user profile properties and sign up system with the ever popular bbPress community forums plugin.","profilegrid-user-profiles-groups-and-communities");?></p>
                        <p class="authors"> <cite><?php _e('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="http://profilegrid.co"><?php _e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                    </div>
                </div>
            ...
            <div class="plugin-card pg-ext-card">
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("Combine the power of ProfileGrid's user groups with WooCommerce cart to provide your users ultimate shopping experience.","profilegrid-user-profiles-groups-and-communities");?></p>
                        <p class="authors"> <cite><?php _e('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="http://profilegrid.co"><?php _e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                    </div>
                </div>
            ...
            <div class="plugin-card pg-ext-card">
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("Assign ProfileGrid users to MailChimp lists with custom field mapping and options for users to manage subscriptions.","profilegrid-user-profiles-groups-and-communities");?></p>
                        <p class="authors"> <cite><?php _e('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="http://profilegrid.co"><?php _e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                    </div>
                </div>
           ...
           <div class="plugin-card pg-ext-card">
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("Allow your users to sign up and login using their favourite social network accounts. Social accounts can be managed from Profile settings.","profilegrid-user-profiles-groups-and-communities");?></p>
                        <p class="authors"> <cite><?php _e('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="http://profilegrid.co"><?php _e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                    </div>
                </div>
            ...
            <div class="plugin-card pg-ext-card">
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("Offer more power and control to your Group Managers. They can edit Groups, approve membership requests, moderate blogs, manage users, etc. from a dedicated frontend Group management area.","profilegrid-user-profiles-groups-and-communities");?></p>
                        <p class="authors"> <cite><?php _e('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="http://profilegrid.co"><?php _e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                        <p>&nbsp;</p>
                    </div>
                </div>
             ...
             <div class="plugin-card pg-ext-card">
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("Enhance the power of ProfileGrid's integration with WooCommerce by adding in integrations with WooCommerce extensions.","profilegrid-user-profiles-groups-and-communities");?></p>
                        <p class="authors"> <cite><?php _e('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="http://profilegrid.co"><?php _e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                        <p>&nbsp;</p>
                    </div>
                </div>
            ...
            <div class="plugin-card pg-ext-card">
                <div class="plugin-card-top">
                    ...
                    <div class="desc column-description">
                        <p><?php _e("Don't stay limited to just one Manager per Group. Unlock the ability to have more than one Managers for your ProfileGrid User Groups now. With all of them sharing the same level of control.","profilegrid-user-profiles-groups-and-communities");?></p>
                        <p class="authors"> <cite><?php _e('By','profilegrid-user-profiles-groups-and-communities');?> <a target="_blank" href="http://profilegrid.co"><?php _e('ProfileGrid','profilegrid-user-profiles-groups-and-communities');?></a></cite></p>
                        <p>&nbsp;</p>
                    </div>
                </div>
