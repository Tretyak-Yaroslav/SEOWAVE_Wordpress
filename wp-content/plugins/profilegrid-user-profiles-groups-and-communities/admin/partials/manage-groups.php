...
<div class="pmagic"> 
  ...
  <div class="pmagic-cards">
    ...
    <div class="pm-card">
      ...
      <div class="pm-last-submission"><a href="admin.php?page=pm_profile_view&id=<?php echo $user->ID; ?>"><?php echo get_avatar($user->user_email,16,'',false,array('class'=>'pm-user'));?> </a> <?php _e("At",'profilegrid-user-profiles-groups-and-communities');?> <?php echo $user->user_registered;?> </div>
      <?php endforeach;?>
