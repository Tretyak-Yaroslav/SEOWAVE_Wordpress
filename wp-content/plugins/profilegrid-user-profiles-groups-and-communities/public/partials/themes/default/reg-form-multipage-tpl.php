...
if ( is_user_logged_in() && $group_member) : ?>
    ...
    <div class="pm-login-box pm-dbfl pm-radius5 pm-border"> 
	  <div class="pm-login-header pm-dbfl pm-bg pm-border-bt">
		  <h4><?php _e( 'You have successfully logged in.','profilegrid-user-profiles-groups-and-communities' );?></h4>
...
<!-----Form Starts----->
 ...
 // $html_creator->pm_get_captcha_html();
  ?>
    ...
    <input type="submit" name="reg_form_submit" class="submit action-button" value="<?php _e('Submit','profilegrid-user-profiles-groups-and-communities');?>" />
