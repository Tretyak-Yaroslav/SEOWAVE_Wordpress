...
class PM_HTML_Creator
{
	...
	public function pm_field_captcha_error($errors)
	{
		...
		<div class="errortext pm_captcha_error">
    	     <?php  _e( 'Sorry, you didn\'t enter the correct captcha code.','profilegrid-user-profiles-groups-and-communities' ); ?>
         </div>
		<?php	
	}
            ...
            if($pagenum<=$num_of_pages)
            {
                    ...
                    <div class="pm-blog-post-wrap pm-dbfl">
                        <div class="pm-blog-img-wrap pm-difl">
                            ...
                            <div class="pm-blog-status pm-difl">
                                <span class="pm-blog-time "><?php printf( _x( '%s ago', '%s = human-readable time difference','profilegrid-user-profiles-groups-and-communities' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ); ?></span>
                ...
                ?>
                    <div class="pg-load-more-container pm-dbfl">
                        ...
                        <input type="submit" class="pm-load-more-blogs" onclick ="load_more_pg_blogs('<?php echo $uid;?>')" value="<?php _e('Load More','profilegrid-user-profiles-groups-and-communities'); ?>" />
                    </div>
                <?php
                endif;
            ...
            else
            {
                ...
                if($uid == $current_user->ID)
                {
                    echo "<div class='pg-alert-warning pg-alert-info'> ";
                     _e("You have not written any blog posts yet. Once you do, they will appear here.",'profilegrid-user-profiles-groups-and-communities');
                    echo "</div>";
                }
                else
                {
                    echo "<div class='pg-alert-warning pg-alert-info'>";
                    echo sprintf(__("Sorry, %s has not made any blog posts yet.",'profilegrid-user-profiles-groups-and-communities'),$displayname);
                    echo "</div>";
                }
    ...
    <path d="M0-.5h24v24H0z" fill="none"/>
            ...
            <div class="pm-section-left-panel pm-section-nav-vertical pm-difl " id="thread_pane">
                ...
                <div class="dbfl pm-new-message-area"><a title="Click here to compose the message" id="new_message_btn" onclick="create_new_message()"><i class="fa fa-plus" aria-hidden="true"></i><?php _e('New Message','profilegrid-user-profiles-groups-and-communities');?></a></div>
...
<div class="pm-section-right-panel">
    ...
    <g transform="matrix(1.05995e-15,17.3103,-17.3103,1.05995e-15,22248.8,-22939.9)">
            ...
            switch ($view) {
                case 1:
                    ...
                    <div class="pm-friend-action-bar pm-dbfl">
                        <button class="pm-difr pm-delete" onclick="pm_multiple_friends_remove('<?php echo $u1;?>')"><?php _e('Remove','profilegrid-user-profiles-groups-and-communities');?></button>
                    </div>
                    <?php
                    break;
                case 2:
                ...
                case 3:
                    ?>
                    <div class="pm-friend-action-bar pm-dbfl">
                        <button class="pm-difr pm-delete" onclick="pm_multiple_friends_request_cancel('<?php echo $u1;?>')"><?php _e('Cancel','profilegrid-user-profiles-groups-and-communities');?></button>
                    </div>
                    <?php
                    break;
            ...
            switch($view)
            {
                case 1:
                    ...
                    else
                    {
                        ...
                        $error = sprintf(__('<span class="pg-alert-warning pg-alert-info">%s does not have any friends yet.</span> ','profilegrid-user-profiles-groups-and-communities'),$display_name);     
                    }
                     break;
                case 2:
        ...
        public function select_all_blog_popup($total,$single)
         {
            ...
            <div class="pm-popup-title pm-dbfl pm-bg-lt pm-pad10 pm-border-bt">
                <?php _e('Confirm','profilegrid-user-profiles-groups-and-communities');?>
        ...
        <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                        ...
                        <div class="pm-field-input">
                           <div class="pmradio">
                               <div class="pm-radio-option">
                                ...
                                <?php _e(sprintf('Select blogs on this page(%s)',$single),'profilegrid-user-profiles-groups-and-communities');?>
                               </div>
                                <div class="pm-radio-option">
                                <input type="radio" name="pm_blog_select_type" id="pm_blog_select_type" value="all">
                                <?php _e(sprintf('Select All(%s)',$total),'profilegrid-user-profiles-groups-and-communities');?>                
                                </div>
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pg_select_blog_posts()"><?php _e('Select','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()" class="pm-remove"><?php _e('Cancel','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
        ...
        public function change_blog_status_popup($post_id)
        {
            ...
            ?>
            <div class="pm-popup-title pm-dbfl pm-bg-lt pm-pad10 pm-border-bt">
                <?php _e('Change Blog Post Status','profilegrid-user-profiles-groups-and-communities');?>
                  <div class="pm-popup-close pm-difr">
                      <img src="<?php echo $path; ?>" height="24px" width="24px">
                  </div>
            </div>
        <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_change_post_status_form" id="pg_change_post_status_form">
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_post_status()"><?php _e('Update','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()" class="pm-remove"><?php _e('Cancel','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
        ...
        public function change_blog_status_success_popup($post_status)
        {
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                        ...
                        _e("Something went wrong. Please try again or contact the admin.","profilegrid-user-profiles-groups-and-communities");
                        else:
                        echo $content;
                        endif;
                        ?>         
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()" class="pm-remove"><?php _e('Close','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
        ...
        public function change_blog_access_control_popup($post_id,$gid)
        {
            ...
            ?>
            <div class="pm-popup-title pm-dbfl pm-bg-lt pm-pad10 pm-border-bt">
                <?php _e('Access Control','profilegrid-user-profiles-groups-and-communities');?>
                  <div class="pm-popup-close pm-difr">
                      <img src="<?php echo $path; ?>" height="24px" width="24px">
                  </div>
            </div>
        <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_change_post_content_access_level" id="pg_change_post_content_access_level">
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
                <div class="pmrow pg-info-message">        
                        ...
                        <?php _e('The post will be accessible to:','profilegrid-user-profiles-groups-and-communities');?>
               ...
               <div class="pmradio">
                   <div class="pm-radio-option">
                    ...
                    <label> <?php _e('Public','profilegrid-user-profiles-groups-and-communities' ); ?></label>
                   </div>
                    <div class="pm-radio-option">
                    <input type="radio" name="pm_content_access" id="pm_content_access" value="2" <?php checked('2',$pm_content_access); ?> />
                    <label> <?php _e('Logged In Users','profilegrid-user-profiles-groups-and-communities' ); ?></label> 
                   </div>
                   
                   <div class="pm-radio-option">
                    <input type="radio" name="pm_content_access" id="pm_content_access" value="5" <?php checked('5',$pm_content_access); ?> />
                    <label> <?php _e('Only Group Members','profilegrid-user-profiles-groups-and-communities' ); ?></label> 
                   </div>
                   
                    <div class="pm-radio-option">
                    <input type="radio" name="pm_content_access" id="pm_content_access" value="3" <?php checked('3',$pm_content_access); ?> />
                    <label> <?php _e("Only Author's Friends",'profilegrid-user-profiles-groups-and-communities' ); ?></label> 
                   </div>
                   
                    <!-- <div class="pm-radio-option">
                    <input type="radio" name="pm_content_access" id="pm_content_access" value="4" <?php checked('4',$pm_content_access); ?> />
                    <label> <?php _e('Only Me','profilegrid-user-profiles-groups-and-communities' ); ?></label> 
                   </div>-->
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_post_access_content()"><?php _e('Update','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()" class="pm-remove"><?php _e('Cancel','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                        ...
                        //echo $content;
                         _e("You changed post's privacy level.","profilegrid-user-profiles-groups-and-communities");
                        endif;
                        ?>         
    ...
    'editor_class' => '','teeny' => false,'dfw' => false,'tinymce' => $tiny,'quicktags' => false
            ...
            ?>
            <div class="pm-popup-title pm-dbfl pm-bg-lt pm-pad10 pm-border-bt">
                <?php _e('Edit Post','profilegrid-user-profiles-groups-and-communities');?>
                  <div class="pm-popup-close pm-difr">
                      <img src="<?php echo $path; ?>" height="24px" width="24px">
                  </div>
            </div>
        <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_edit_blog_post" id="pg_edit_blog_post">
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_edit_blog_post()"><?php _e('Update','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()" class="pm-remove"><?php _e('Cancel','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
                ...
                <div class="pmrow">        
                    <div class="pm-col">
                        ...
                        _e("Something went wrong. Please try again or contact the admin.","profilegrid-user-profiles-groups-and-communities");
                         ...
                         _e('The post was updated successfully!','profilegrid-user-profiles-groups-and-communities');
                        endif;
                        ?>         
        ...
        public function add_admin_note_on_blog_post_popup($post_id,$gid)
        {
            ...
            ?>
            <div class="pm-popup-title pm-dbfl pm-bg-lt pm-pad10 pm-border-bt">
                <?php _e("Manager Note",'profilegrid-user-profiles-groups-and-communities');?>
                  <div class="pm-popup-close pm-difr">
                      <img src="<?php echo $path; ?>" height="24px" width="24px">
                  </div>
            </div>
        <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_add_admin_note" id="pg_add_admin_note">
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
                ...
                <div class="pg-users-send-box pm-dbfl">        
                        ...
                        <div class="pm-field-lable pm-difl">
                                <label for="pm_admin_note_content"><?php _e('Content','profilegrid-user-profiles-groups-and-communities');?></label>
                        </div>
                        <div class="pm-field-input pm-difl">
                            <textarea name="pm_admin_note_content" id="pm_admin_note_content" maxlength="5000" size="5000" onkeyup="pg_count_left_charactors('pm_admin_note_content','pg_text_counter','{CHAR} <?php _e('characters left','profilegrid-user-profiles-groups-and-communities');?>','5000')"><?php if(isset($pm_admin_note_content))echo $pm_admin_note_content;?></textarea>          
                            <div class="errortext" style="display:none;"></div>
                            <div id="pg_text_counter"><?php _e(sprintf('%d characters left',$char_limit),'profilegrid-user-profiles-groups-and-communities');?></div>
                        </div>

                </div>
                <div class="pg-users-send-box pm-dbfl">        
                        <div class="pm-field-lable pm-difl">
                                <label for="pm_admin_note_position"><?php _e('Position:','profilegrid-user-profiles-groups-and-communities');?></label>
                        </div>
                        <div class="pm-field-input pm-difl">
               <div class="pmradio">
                ...
                <?php _e('Top','profilegrid-user-profiles-groups-and-communities' ); ?>
                   </div>
                    <div class="pm-radio-option pm-difl">
                    ...
                    <?php _e('Bottom','profilegrid-user-profiles-groups-and-communities' ); ?>
                   </div>
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                ...
                {?>
                   <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_post_admin_note_content()"><?php _e('Add','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <?php
                }
                else
                {?>
                    <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_post_admin_note_content()"><?php _e('Update','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                    <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_delete_admin_note_content()"><?php _e('Delete','profilegrid-user-profiles-groups-and-communities');?></a></div> 
         ...
         <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_delete_admin_note" id="pg_delete_admin_note">
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                        <?php 
                            _e('Please confirm you wish to delete this Manager Note from the post.' ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                </div>
            </div>
           ...
           <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pm_delete_admin_note()"><?php _e('Yes','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()" class="pm-remove"><?php _e('No','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
                ...
                <div class="pmrow">        
                    <div class="pm-col">
                        ...
                        _e("Something went wrong. Please try again or contact the admin.","profilegrid-user-profiles-groups-and-communities");
                         ...
                         _e('The Manager Note was deleted successfully.','profilegrid-user-profiles-groups-and-communities');
                        endif;
                        ?>         
        ...
        public function send_message_to_author_popup($post_id,$gid,$type='blog')
        {
            ...
            ?>
            <div class="pm-popup-title pm-dbfl pm-bg-lt pm-pad10 pm-border-bt">
                <?php _e("New Message",'profilegrid-user-profiles-groups-and-communities');?>
                  <div class="pm-popup-close pm-difr">
                      <img src="<?php echo $path; ?>" height="24px" width="24px">
                  </div>
            </div>
        <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_send_author_message" id="pg_send_author_message">
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
                <div class="pmrow">        
                    <div class="pg-users-send-box pm-dbfl">
                        ...
                        <div class="pm-field-lable pm-difl">
                                <label><?php _e('To:','profilegrid-user-profiles-groups-and-communities');?></label>
                        </div>
                        <div class="pm-field-input pm-difl">
                ...
                <div class="pmrow">        
                    <div class="pg-users-send-box pm-dbfl">
                        ...
                        <div class="pm-field-lable pm-difl">
                                <label for="pm_author_message"><?php _e('Message:','profilegrid-user-profiles-groups-and-communities');?></label>
                        </div>
                        <?php if($type=='blog'):?>
                        <div class="pm-field-input pm-difl">
                           <textarea name="pm_author_message" id="pm_author_message" ><?php _e(sprintf('About your blog post: %s',$post->post_title),'profilegrid-user-profiles-groups-and-communities');?></textarea>          
                            <div class="errortext" style="display:none;"></div>
                            
                        </div>   
                        <?php else:?>
                        <div class="pm-field-input pm-difl">
                            <textarea name="pm_author_message" id="pm_author_message" placeholder="<?php _e('Type your message here','profilegrid-user-profiles-groups-and-communities');?>"></textarea>          
                            <div class="errortext" style="display:none;"></div>
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_author_message()"><?php _e('Send','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()" class="pm-remove"><?php _e('Cancel','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
        ...
        public function add_user_in_group_popup($gid)
        {
            ...
            ?>
            <div class="pm-popup-title pm-dbfl pm-bg-lt pm-pad10 pm-border-bt">
                <?php _e("Add User",'profilegrid-user-profiles-groups-and-communities');?>
                  <div class="pm-popup-close pm-difr">
                      <img src="<?php echo $path; ?>" height="24px" width="24px">
                  </div>
            </div>
        <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_add_user" id="pg_add_user">
                    <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
                     ...
                     <div class="pm-dbfl pg-info-message">        
                                ...
                                <?php
                                _e('You can simultaneously add upto <strong>10 users</strong> to your group using this method.', 'profilegrid-user-profiles-groups-and-communities');
                                ?>         
                    ...
                    <div class="group-popup-container">
                        <div class="pm-field-input pm-pad10 pm-dbfl">
                            <div class="pm_repeat pm-pad10">
                                ...
                                <a class="pg-add-user"><span onClick="pm_add_repeat(this)"><?php _e('Add More', 'profilegrid-user-profiles-groups-and-communities'); ?></span></a><a class="pg-remove-user pm-remove"><span class="remove" onClick="pm_remove_repeat(this)"><?php _e('Remove', 'profilegrid-user-profiles-groups-and-communities'); ?></span></a>
                                <div class="errortext" style="display:none;"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pg_invite_user()"><?php _e('Invite','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()" class="pm-remove"><?php _e('Cancel','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
        ...
        public function invitation_send_result_success_popup($result)
        {
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-dbfl pg-info-message">
                        <?php _e('Here are the results of User Invites you just sent.','profilegrid-user-profiles-groups-and-communities');?>         
                    </div>
                </div>
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove" onclick="pg_edit_popup_close()"><?php _e('Close','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
        ...
        public function remove_user_in_group_popup($id,$gid)
        {
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                        <?php 
                            _e('Please confirm you really want to remove the user from the group.' ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                </div>
            </div>
           ...
           <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pm_remove_user_from_group()"><?php _e('Yes','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove" onclick="pg_edit_popup_close()"><?php _e('No','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
        ...
        public function remove_admin_in_group_popup($id,$gid)
        {
                ...
                <div class="pmrow">        
                    <div class="pm-col">
                        <?php 
                            ...
                            _e(sprintf('You are going to remove <strong>%s</strong> from the Group Manager List. The user will still remain a member of the group. Do you wish to proceed?',$user->user_login) ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                </div>
            </div>
           ...
           <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pm_remove_admin_from_group()"><?php _e('Yes','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove" onclick="pg_edit_popup_close()"><?php _e('No','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
         ...
         <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_deactivate_user_in_group" id="pg_deactivate_user_in_group">
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                        <?php 
                            _e('Please confirm you really want to suspend the user from the group.' ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                </div>
            </div>
           ...
           <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pm_deactivate_user_from_group()"><?php _e('Yes','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove" onclick="pg_edit_popup_close()"><?php _e('No','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
         ...
         <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_reset_user_password" id="pg_reset_user_password">
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap"> 
                ...
                <div class="pmrow">
                    <div class="pm-dbfl pg-info-message">
                        <?php 
                            _e('Enter a new password manually or autogenerate.' ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                
                <div class="group-popup-container">
                     <div class="pm-field-input">
                         <input type='password' id='pm_new_pass' name='pm_new_pass' placeholder="<?php _e('Enter New Password','profilegrid-user-profiles-groups-and-communities');?>" onkeyup="pg_check_password_strenth()" />	
                 ...
                 <div class="pg-email-password pm-dbfl">
                             ...
                             <div class="pm-field-input">
                                 ...
                                 <?php _e('Email new password to the user', 'profilegrid-user-profiles-groups-and-communities'); ?>
                                 </label>
                             </div>             
                         </div>
           ...
           <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a id="pm_member_reset_password_link" class="pg-setting-disabled"><?php _e('Reset','profilegrid-user-profiles-groups-and-communities');?></a></div> 
         ...
         public function pm_reset_user_password_success_popup($name,$is_emailed)
        {
            ...
            ?>
            <div class="pm-popup-title pm-dbfl pm-bg-lt pm-pad10 pm-border-bt">
                <?php _e('Success!','profilegrid-user-profiles-groups-and-communities');?>
                <div class="pm-popup-close pm-difr" onclick="pg_edit_popup_close()">
                      <img src="<?php echo $path; ?>" height="24px" width="24px">
                  </div>
            </div>
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                        <?php if($is_emailed):
                        _e(sprintf("Password for user <b>%s</b> was reset and emailed successfully.",$name),"profilegrid-user-profiles-groups-and-communities");
                        else:
                            _e( sprintf("Password for user <b>%s</b> was reset successfully.",$name),'profilegrid-user-profiles-groups-and-communities');
                        endif;
                        ?>         
        ...
        <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_change_post_status_form" id="pg_change_post_status_form">
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                 ...
                 <div class="pmrow pg-info-message">        
                        ...
                        <?php _e(sprintf('You are going to change status of <b>%d</b> selected blog posts.',$count),'profilegrid-user-profiles-groups-and-communities');?>
        ...
        <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_change_post_content_access_level" id="pg_change_post_content_access_level">
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
                <div class="pmrow pg-info-message">        
                        ...
                        <?php _e(sprintf('Selected <b>%d</b> post(s) will be accessible to:',$count),'profilegrid-user-profiles-groups-and-communities');?>
               ...
               <div class="pmradio">
                   <div class="pm-radio-option">
                    ...
                    <label for="pm_post_access_public"><?php _e('Public','profilegrid-user-profiles-groups-and-communities' ); ?></label>
                   </div>
                    <div class="pm-radio-option">
                    <input type="radio" name="pm_content_access" id="pm_post_access_logged-in-users" value="2" <?php checked('2',$pm_content_access); ?> />
                    <label for="pm_post_access_logged-in-users"> <?php _e('Logged In Users','profilegrid-user-profiles-groups-and-communities' ); ?></label>
                   </div>
                   
                   <div class="pm-radio-option">
                    <input type="radio" name="pm_content_access" id="pm_post_access-group-member" value="5" <?php checked('5',$pm_content_access); ?> />
                    <label for="pm_post_access-group-member"><?php _e('Only Group Members','profilegrid-user-profiles-groups-and-communities' ); ?></label>
                   </div>
                   
                    <div class="pm-radio-option">
                    <input type="radio" name="pm_content_access" id="pm_post_access-user-friends" value="3" <?php checked('3',$pm_content_access); ?> />
                    <label for="pm_post_access-user-friends"><?php _e("Only Author's Friends",'profilegrid-user-profiles-groups-and-communities' ); ?></label>
                   </div>
                ...
                <div class="pmrow ">        
                    <div class="pg-users-send-box pm-dbfl">
                        ...
                        <div class="pm-field-input pm-difl">
                            <textarea name="pm_admin_note_content" id="pm_admin_note_content" maxlength="5000" size="5000" onkeyup="pg_count_left_charactors('pm_admin_note_content','pg_text_counter','{CHAR} <?php _e('characters left','profilegrid-user-profiles-groups-and-communities');?>','5000')"><?php if(isset($pm_admin_note_content))echo $pm_admin_note_content;?></textarea>          
                            <div class="errortext" style="display:none;"></div>
                            <div id="pg_text_counter"><?php _e(sprintf('<b>%d</b> characters left',$char_limit),'profilegrid-user-profiles-groups-and-communities');?></div>
                        </div>
                    </div>
                </div>
                <div class="pmrow">        
                ...
                <div class="pmrow">        
                    <div class="pg-users-send-box pm-dbfl">
                        ...
                        <div class="pm-field-input pm-difl pm-popup-title">
                            <?php _e(sprintf('%d Recipient(s)',$count),'profilegrid-user-profiles-groups-and-communities');?>
                        </div>
                    </div>
                </div>
                <div class="pmrow">        
        ...
        public function remove_bulk_user_in_group_popup($id,$gid)
        {
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                        <?php 
                            _e(sprintf('You are going to remove <b>%d</b> user(s). Do you wish to proceed?',$count) ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                </div>
            </div>
         ...
         <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_deactivate_user_in_group" id="pg_deactivate_user_in_group">
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                         <?php 
                            _e(sprintf('You are going to suspend <b>%d</b> user(s). Do you wish to proceed?',$count) ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                </div>
            </div>
        ...
        public function pg_remove_group_in_user_profile_popup($id,$gid)
        {
            ...
            $path =  plugins_url( '../public/partials/images/popup-close.png', __FILE__ );
            ($postid=='failed')?$title = __('Failed!','profilegrid-user-profiles-groups-and-communities'):$title = __('Leave Group','profilegrid-user-profiles-groups-and-communities');
            ?>
            <div class="pm-popup-title pm-dbfl pm-bg-lt pm-pad10 pm-border-bt">
                <?php echo $title;?>
                  <div class="pm-popup-close pm-difr">
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">  
                    <?php if($is_leader):?>
                     <div class="pm-col">
                        <?php 
                            echo sprintf(__('You are currently %s of this group. Leaving the group will remove your %s privileges along with group membership. To regain %s privileges in future, another %s must assign you the role first. Do you wish to proceed?' ,'profilegrid-user-profiles-groups-and-communities'),$group_manager_label,$group_manager_label,$group_manager_label,$group_manager_label);
                       ?>         
                    </div>
                    <?php else:?>
                    <div class="pm-col">
                        <?php 
                            echo sprintf(__('You are about to leave %s group. You will no longer have access to Group updates or Group related information. Do you wish to continue?' ,'profilegrid-user-profiles-groups-and-communities'),$groupinfo->group_name);
                       ?>         
                    </div>
                    <?php endif;?>
           ...
           <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pg_remove_user_group('<?php echo esc_attr($id);?>','<?php echo esc_attr($gid);?>')"><?php _e('Yes','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove" onclick="pg_edit_popup_close()"><?php _e('No','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
            <input type="hidden" name="action" id="action" value="pm_remove_user_from_group" />
             <?php wp_nonce_field('remove_pm_user_from_group'); ?>
        ...
        public function pg_decline_request_to_join_group_popup($id,$gid)
        {
            ...
            ?>
            <div class="pm-popup-title pm-dbfl pm-bg-lt pm-pad10 pm-border-bt">
                <?php echo __('Decline Request','profilegrid-user-profiles-groups-and-communities');?>
                  <div class="pm-popup-close pm-difr">
                      <img src="<?php echo $path; ?>" height="24px" width="24px">
                  </div>
            </div>
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">  
                    <div class="pm-dbfl pg-info-message">
                        <?php 
                           _e('You are about to decline membership request by:' ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                      </div>
                <div class="pmrow">  
           ...
           <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pg_decline_join_request('<?php echo esc_attr($id);?>','<?php echo esc_attr($gid);?>')"><?php _e('Decline','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove" onclick="pg_edit_popup_close()"><?php _e('Cancel','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
        ...
        public function pg_accept_request_to_join_group_popup($id,$gid)
        {
            ...
            ?>
            <div class="pm-popup-title pm-dbfl pm-bg-lt pm-pad10 pm-border-bt">
                <?php echo __('Approve Request','profilegrid-user-profiles-groups-and-communities');?>
                  <div class="pm-popup-close pm-difr">
                      <img src="<?php echo $path; ?>" height="24px" width="24px">
                  </div>
            </div>
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">  
                    <div class="pm-dbfl pg-info-message">
                        <?php 
                           _e('You are about to approve membership request by:' ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                </div>
           ...
           <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pg_approve_join_request('<?php echo esc_attr($id);?>','<?php echo esc_attr($gid);?>')"><?php _e('Approve','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove" onclick="pg_edit_popup_close()"><?php _e('Cancel','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
            <input type="hidden" name="action" id="action" value="pm_decline_join_request" />
             <?php wp_nonce_field('decline_pm_join_request'); ?>
        ...
        public function pg_join_paid_group_html($gid,$uid)
        {
            ...
            <form method="post" class="pmagic-form pm-dbfl">
                <fieldset>
                <legend><?php _e('Payment','profilegrid-user-profiles-groups-and-communities');?></legend>
                ...
                <input type="submit" name="pg_join_paid_group_form" id="pg_join_paid_group_form" class="pm_button" value="<?php _e('Join Group','profilegrid-user-profiles-groups-and-communities');?>" />
                </div>
            </form>
            </div>
            </div>
         ...
         <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_decline_bulk_join_group_requests" id="pg_decline_bulk_join_group_requests">
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                         <?php 
                            _e(sprintf('You are going to decline <b>%d</b> group membership user requests. Do you wish to proceed?',$count) ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                </div>
            </div>
           ...
           <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pm_decline_bulk_join_group_requests()"><?php _e('Decline','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove" onclick="pg_edit_popup_close()"><?php _e('Cancel','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
         ...
         <form action="<?php echo admin_url( 'admin-ajax.php' );?>" method="post" name="pg_decline_bulk_join_group_requests" id="pg_decline_bulk_join_group_requests">
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">  
                <div class="pmrow">        
                    <div class="pm-col">
                         <?php 
                            _e(sprintf('You are going to approve <b>%d</b> group membership user requests. Do you wish to proceed?',$count) ,'profilegrid-user-profiles-groups-and-communities');
                       ?>         
                    </div>
                </div>
            </div>
           ...
           <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pm_approve_bulk_join_group_requests()"><?php _e('Approve','profilegrid-user-profiles-groups-and-communities');?></a></div> 
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove" onclick="pg_edit_popup_close()"><?php _e('Cancel','profilegrid-user-profiles-groups-and-communities');?></a></div> 
            </div>
            ...
            if($pagenum<=$num_of_pages)
            {
                ...
                ?>
                    <div class="pg-load-more-container pm-dbfl">
                        <div class="pm-loader" style="display:none;"></div>
                        <input type="hidden" id="pg_next_blog_page" value="<?php echo $pagenum + 1; ?>" />
                        <input type="submit" class="pm-load-more-blogs" onclick ="load_more_user_blogs_shortcode_posts('<?php echo $authors;?>','<?php echo $posttypes;?>')" value="<?php _e('Load More','profilegrid-user-profiles-groups-and-communities'); ?>" />
                    </div>
                <?php
                endif;
